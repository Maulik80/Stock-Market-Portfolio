...
const Stocks = ({ addToWatchlist }) => {
  ...
  // This will log the fetched stock data
  console.log(stocks, "--- Stocks data fetched ---"); 
...
const Watchlist = ({ watchlist }) => {
  ...
  // This will log when the component loads
  console.log('--- Watchlist Page Opened ---');
  console.log(watchlist, '--- Current Watchlist Data ---'); 
